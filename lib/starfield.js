...
window.Starfield = function() {
  ...
  var NUM_STARS = 5000,
    ...
    // TODO fix this hack!
    STAR_IMAGE = window.location.hostname === 'localhost' ? '../images/star-round.png' : '/browser-strikes-back-jsoxford-2017/images/star-round.png',
    starTexture = THREE.ImageUtils.loadTexture(STAR_IMAGE);
